...
var FACTORY_ADDRESS_MAP =
  ...
  (_FACTORY_ADDRESS_MAP[84532] = '0xfaa89f95CE1948582154ee1C0Ea47701cBb95E04'),
  (_FACTORY_ADDRESS_MAP[167000] = '0xfCA1AEf282A99390B62Ca8416a68F5747716260c'),
  _FACTORY_ADDRESS_MAP)
...
var SwapMath = /*#__PURE__*/ (function() {
  ...
  SwapMath.computeSwapStep = function computeSwapStep(
    ...
    if (exactIn) {
      var amountRemainingLessFee = JSBI.divide(
...
var NoTickDataProvider = /*#__PURE__*/ (function() {
  ...
  _proto.getTick = /*#__PURE__*/ (function() {
    var _getTick = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee(_tick) {
  ...
  _proto.nextInitializedTickWithinOneWord = /*#__PURE__*/ (function() {
    var _nextInitializedTickWithinOneWord = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee2(_tick, _lte, _tickSpacing) {
...
var TickList = /*#__PURE__*/ (function() {
  ...
  TickList.validateList = function validateList(ticks, tickSpacing) {
    ...
    !ticks.every(function(_ref) {
      ...
      : void 0 // ensure tick liquidity deltas sum to 0
...
var TickListDataProvider = /*#__PURE__*/ (function() {
  ...
  _proto.getTick = /*#__PURE__*/ (function() {
    var _getTick = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee(tick) {
  ...
  _proto.nextInitializedTickWithinOneWord = /*#__PURE__*/ (function() {
    var _nextInitializedTickWithinOneWord = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ runtime_1.mark(function _callee2(tick, lte, tickSpacing) {
        return runtime_1.wrap(
...
var Pool = /*#__PURE__*/ (function() {
  ...
  Pool.getAddress = function getAddress(tokenA, tokenB, fee, initCodeHashManualOverride) {
    ...
    return computePoolAddress({
      factoryAddress:
        (_FACTORY_ADDRESS_MAP$ = FACTORY_ADDRESS_MAP[tokenA.chainId]) != null ? _FACTORY_ADDRESS_MAP$ : FACTORY_ADDRESS,
      fee: fee,
      tokenA: tokenA,
      tokenB: tokenB,
  ...
  _proto.getOutputAmount =
    ...
    (function() {
      var _getOutputAmount = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee(inputAmount, sqrtPriceLimitX96) {
  ...
  _proto.getInputAmount =
    ...
    (function() {
      var _getInputAmount = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee2(outputAmount, sqrtPriceLimitX96) {
  ...
  _proto.swap =
    ...
    (function() {
      var _swap = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee3(zeroForOne, amountSpecified, sqrtPriceLimitX96) {
              ...
              while (1) {
                switch ((_context3.prev = _context3.next)) {
                  ...
                  case 4:
                    ...
                    _context3.next = 9
                    return this.tickDataProvider.nextInitializedTickWithinOneWord(
                      state.tick,
                      zeroForOne,
                      this.tickSpacing
                    )
...
var Trade = /*#__PURE__*/ (function() {
  ...
  Trade.exactIn =
    ...
    (function() {
      var _exactIn = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee(route, amountIn) {
          return runtime_1.wrap(function _callee$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
  ...
  Trade.exactOut =
    ...
    (function() {
      var _exactOut = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee2(route, amountOut) {
          return runtime_1.wrap(function _callee2$(_context2) {
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
  ...
  Trade.fromRoute =
    ...
    (function() {
      var _fromRoute = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee3(route, amount, tradeType) {
          var amounts,
            inputAmount,
            outputAmount,
            i,
  ...
  Trade.fromRoutes =
    ...
    (function() {
      var _fromRoutes = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ runtime_1.mark(function _callee4(routes, tradeType) {
          var populatedRoutes,
            _iterator3,
            _step3,
            _step3$value,
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance, amountIn) {
    ...
    if (this.tradeType === sdkCore.TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new sdkCore.Fraction(ONE).add(slippageTolerance).multiply(amountIn.quotient)
        .quotient
    ...
    if (singleHop) {
      if (tradeType === sdkCore.TradeType.EXACT_INPUT) {
        ...
        calldata = SwapQuoter.INTERFACE.encodeFunctionData('quoteExactOutputSingle', [
          ...
          quoteAmount,
          toHex(
            (_options$sqrtPriceLim2 = (_options2 = options) == null ? void 0 : _options2.sqrtPriceLimitX96) != null
      ...
      !(((_options3 = options) == null ? void 0 : _options3.sqrtPriceLimitX96) === undefined)
